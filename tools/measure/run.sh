...
for measurement in ${only:-MeasureHoles MeasureReferences MeasureMigrations MeasureRequired MeasureScalars MeasureLocalization MeasureTags MeasureFlags MeasureUsages MeasureLocaleRename MeasureAliases MeasureEntityLoc MeasureGuidebook MeasureTypedIds MeasureSiblings MeasureCodeLinks MeasureDeadLocale}; do
  echo "== $measurement"
