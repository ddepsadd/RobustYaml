...
if [ "$darwin" = "true" ]; then
    ...
    x86_64)
        ...
        JVM_TARGET_DIR=$BUILD_DIR/jdk-25.0.3_macos-x64_bin-a5f930
        ;;
    arm64)
        JVM_URL=https://download.oracle.com/java/25/archive/jdk-25.0.3_macos-aarch64_bin.tar.gz
        JVM_TARGET_DIR=$BUILD_DIR/jdk-25.0.3_macos-aarch64_bin-5e8f4b
        ;;
    *) 
