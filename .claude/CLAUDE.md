...
Тесты остались одним пакетом: их 18, каждый назван по тому, что проверяет, и раскладывать их
...
попавшимся `getParentOfType`. Такие вещи закрываются тестами: `./gradlew :test`, 188 случаев,
5 секунд.
